...
while  True:
    ...
    if (pergunta == "Quem dirige a vida de Joan em tempo real para uma série de televisão?"):
        ...
        print("\nJoan descobriu a série indo assistir algo na hora do jantar, seu noivo insiste em ver a serie com uma atriz que se assemelha a ela\n")
        ...
        print("Não tenho conhecimentos suficiente sobre essa pergunta, lamento.")
